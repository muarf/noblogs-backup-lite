...
if [[ "$USER_LANG" == en* ]]; then
  ...
  L_TAG="Downloading version v2.1.2…"
  L_MAIN="v2.1.2 not found, using latest main…"
  ...
  L_TAG="Download versione v2.1.2…"
  L_MAIN="v2.1.2 non trovata, uso l'ultima main…"
  ...
  L_TAG="Téléchargement de la version v2.1.2…"
  L_MAIN="v2.1.2 introuvable, bascule sur la dernière main…"
...
TAG_URL="https://codeload.github.com/muarf/noblogs-backup-lite/tar.gz/refs/tags/v2.1.2"
